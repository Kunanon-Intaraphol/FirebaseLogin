...
const Frame = ({title , text , FAI ,Status ,TAI}) => {
    ...
    <h4 style={{marginTop:"30px"}}>มีความเสี่ยงที่จะเป็นข่าวปลอม :<h8 style={{fontSize:"18px",color:"#2ae85d"}}>{FAI}%{"\n"}</h8></h4>
    <h4>มีความคล้ายที่จะเป็นข่าวจริง :<h9 style={{fontSize:"18px",color:"#2ae85d"}}>{TAI}%{"\n"}</h9></h4>
